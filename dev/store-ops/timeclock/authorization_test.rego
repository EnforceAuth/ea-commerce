...
mock_users := {
	...
	"district_mgr": {
		...
		"permissions": ["timeclock:punch", "timeclock:view_team", "timeclock:approve", "timeclock:edit", "timeclock:payroll_export"],
		"department": "store_ops",
		"active": true,
		"exp": 9999999999,
		"store_id": "STORE-HQ",
...
test_cashier_clock_in if {
	authorization.allow_punch with input as {
		"request": {
			"http": {
				"method": "POST",
...
test_cashier_wrong_store_denied if {
	not authorization.allow_punch with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/timeclock/clock-in",
...
test_cashier_view_own_timecard if {
	authorization.allow_view_own_timecard with input as {
		"request": {
			"http": {
				"method": "GET",
...
test_cashier_view_team_denied if {
	not authorization.allow_view_team_timecards with input as {
		"request": {
			"http": {
				"method": "GET",
				"path": "/timeclock/team",
...
test_shift_lead_view_team if {
	authorization.allow_view_team_timecards with input as {
		"request": {
			"http": {
				"method": "GET",
				"path": "/timeclock/team",
...
test_shift_lead_approve_denied if {
	not authorization.allow_approve_timecard with input as {
		"request": {
			"http": {
				"method": "POST",
...
test_store_mgr_approve if {
	authorization.allow_approve_timecard with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/timeclock/approve/TC-001",
...
test_store_mgr_edit_with_reason if {
	authorization.allow_edit_timecard with input as {
		"request": {
			"http": {
				"method": "PATCH",
...
test_store_mgr_edit_no_reason_denied if {
	not authorization.allow_edit_timecard with input as {
		"request": {
			"http": {
				"method": "PATCH",
				"path": "/timeclock/timecard/TC-001",
...
test_store_mgr_payroll_denied if {
	not authorization.allow_payroll_export with input as {
		"request": {
			"http": {
				"method": "GET",
...
test_district_mgr_payroll_export if {
	authorization.allow_payroll_export with input as {
		"request": {
			"http": {
				"method": "GET",
				"path": "/timeclock/payroll-export",
