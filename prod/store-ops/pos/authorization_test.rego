...
test_cashier_can_sell if {
	authorization.allow_sale with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/pos/sale",
...
test_inactive_cashier_denied if {
	not authorization.allow_sale with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/pos/sale",
...
test_cashier_return_under_limit if {
	authorization.allow_return with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/pos/return",
...
test_cashier_return_over_limit_denied if {
	not authorization.allow_return with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/pos/return",
...
test_cashier_void_denied if {
	not authorization.allow_void with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/pos/void",
...
test_shift_lead_void_allowed if {
	authorization.allow_void with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/pos/void",
...
test_shift_lead_discount_within_limit if {
	authorization.allow_price_override with input as {
		"request": {
			"http": {
				"method": "POST",
...
test_shift_lead_discount_over_limit_denied if {
	not authorization.allow_price_override with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/pos/price-override",
...
test_cashier_close_register_denied if {
	not authorization.allow_close_register with input as {
		"request": {
			"http": {
				"method": "POST",
...
test_shift_lead_close_register if {
	authorization.allow_close_register with input as {
		"request": {
			"http": {
				"method": "POST",
				"path": "/pos/close-register",
